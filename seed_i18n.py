...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "referral.type.healthcare": {"en": "Healthcare Provider", "ms": "Penyedia Penjagaan Kesihatan", "zh": "医疗保健提供者", "ta": "சுகாதார வழங்குநர்"},
    "referral.type.kementerian": {"en": "Kementerian Kesihatan", "ms": "Kementerian Kesihatan", "zh": "Kementerian Kesihatan", "ta": "Kementerian Kesihatan"},
